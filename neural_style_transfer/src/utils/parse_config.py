...
def _parse_dataset_section(cfg: DictConfig, mode: str = None, mode_groups: DictConfig = None, hardware_type: str = None) -> None:
    """
        This function checks the dataset section of the config file.
        ...
        Returns:
            None
    """
    legal = ["name", "training_path", "validation_path", "validation_split", "test_path",
             "quantization_path", "quantization_split", "check_image_files", "seed"]

    required = []
    check_config_attributes(cfg, specs={"legal": legal, "all": required}, section="dataset")
...
def _parse_postprocessing_section(cfg: DictConfig) -> None:
    ...
    legal = ["bilateral_diameter", "sigma_color", "sigma_space", "scaling_alpha", "scaling_beta",
             'saturation_scale']
    required = ["bilateral_diameter", "sigma_color", "sigma_space", "scaling_alpha", "scaling_beta",
             'saturation_scale']
