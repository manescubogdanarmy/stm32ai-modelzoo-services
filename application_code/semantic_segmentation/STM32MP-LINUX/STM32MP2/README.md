...
The [deployment script](../../../../semantic_segmentation/docs/README_DEPLOYMENT_MPU.md) of the model zoo is used to directly populate the target with all the needed files, resources and NN model. The script use
