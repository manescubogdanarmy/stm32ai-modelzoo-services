...
def st_yolo_x(input_shape, num_anchors, num_classes, depth_mul=0.33, width_mul=0.25):
    ...
    """
    return _YOLOX(input_shape=input_shape,num_classes=num_classes,num_anchors=num_anchors,use_depthwise_conv=True, activation="relu6", depth_mul=depth_mul, width_mul=width_mul, model_name="st_yolo_x")
