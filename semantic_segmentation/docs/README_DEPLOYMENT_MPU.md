# Semantic Segmentation STM32MPU Model Deployment
...
[X-LINUX-AI](https://www.st.com/en/embedded-software/x-linux-ai.html) expansion package for OpenSTLinux version `v6.1.0` is required on the target board to be able to use the following semantic segmentation deployment application.
...
- `c_project_path` - *Path* to [X-LINUX-AI application code](../../application_code/semantic_segmentation/STM32MP-LINUX/README.md) project.
...
- `board` - **STM32MP257F-EV1** , see the [README](../../application_code/semantic_segmentation/STM32MP-LINUX/README.md) for more details.
