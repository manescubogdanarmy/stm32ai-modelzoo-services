...
def add_color(connections,color):
    return [c+[color] for c in connections]

FACEMESH_LIPS = add_color(FACEMESH_LIPS,'UTIL_LCD_COLOR_BLUE')

FACEMESH_LEFT_EYE  = add_color(FACEMESH_LEFT_EYE,'UTIL_LCD_COLOR_ORANGE')
FACEMESH_RIGHT_EYE = add_color(FACEMESH_RIGHT_EYE,'UTIL_LCD_COLOR_ORANGE')

FACEMESH_LEFT_EYEBROW  = add_color(FACEMESH_LEFT_EYEBROW,'UTIL_LCD_COLOR_GREEN')
FACEMESH_RIGHT_EYEBROW = add_color(FACEMESH_RIGHT_EYEBROW,'UTIL_LCD_COLOR_GREEN')

FACEMESH_LEFT_IRIS  = add_color(FACEMESH_LEFT_IRIS,'UTIL_LCD_COLOR_MAGENTA')
FACEMESH_RIGHT_IRIS = add_color(FACEMESH_RIGHT_IRIS,'UTIL_LCD_COLOR_MAGENTA')

FACEMESH_TESSELATION = add_color(FACEMESH_TESSELATION,'UTIL_LCD_COLOR_ST_BLUE')


stm32_to_opencv_colors_dict = {'UTIL_LCD_COLOR_ST_BLUE':(60,136,182),
                               'UTIL_LCD_COLOR_BLUE':(0,0,255),
                               'UTIL_LCD_COLOR_ORANGE':(255,128,0),
                               'UTIL_LCD_COLOR_GREEN':(0,255,0),
                               'UTIL_LCD_COLOR_MAGENTA':(255,0,255)}


skeleton_connections_dict = {'head':   {468:FACEMESH_TESSELATION+FACEMESH_LIPS\
                                            +FACEMESH_LEFT_EYE+FACEMESH_RIGHT_EYE\
                                            +FACEMESH_LEFT_EYEBROW+FACEMESH_RIGHT_EYEBROW,
                                        478:FACEMESH_TESSELATION+FACEMESH_LIPS\
                                            +FACEMESH_LEFT_EYE+FACEMESH_RIGHT_EYE\
                                            +FACEMESH_LEFT_EYEBROW+FACEMESH_RIGHT_EYEBROW\
                                            +FACEMESH_LEFT_IRIS+FACEMESH_RIGHT_IRIS},
                             'hand':   {21:[[ 0,  1, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 1,  2, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 2,  3, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 3,  4, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 0,  5, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 5,  6, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 6,  7, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 7,  8, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 5,  9, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 9, 10, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [10, 11, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [11, 12, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 9, 13, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [13, 14, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [14, 15, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [15, 16, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [13, 17, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [17, 18, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [18, 19, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [19, 20, 'UTIL_LCD_COLOR_ST_BLUE'],
                                            [ 0, 17, 'UTIL_LCD_COLOR_ST_BLUE']]},
                             'person': {17:[[15, 13, 'UTIL_LCD_COLOR_ORANGE'],
                                            ...
                                            [ 1,  2, 'UTIL_LCD_COLOR_GREEN'],
                                            [ 0,  1, 'UTIL_LCD_COLOR_GREEN'],
                                            [ 0,  2, 'UTIL_LCD_COLOR_GREEN'],
                                            [ 1,  3, 'UTIL_LCD_COLOR_GREEN'],
                                            [ 2,  4, 'UTIL_LCD_COLOR_GREEN'],
                                            [ 3,  5, 'UTIL_LCD_COLOR_GREEN'],
                                            [ 4,  6, 'UTIL_LCD_COLOR_GREEN'],
                                            [ 5,  6, 'UTIL_LCD_COLOR_BLUE'],
                                            [ 5,  7, 'UTIL_LCD_COLOR_BLUE'],
                                            [ 6,  8, 'UTIL_LCD_COLOR_BLUE'],
                                            [ 7,  9, 'UTIL_LCD_COLOR_BLUE'],
                                            [ 8, 10, 'UTIL_LCD_COLOR_BLUE']],
                                        13:[[11,  9, 'UTIL_LCD_COLOR_ORANGE'],
