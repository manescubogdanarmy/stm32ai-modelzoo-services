...
............
```
The names of the subdirectories under the dataset root directory are the names of the classes. They have to be aligned with the class names defined in [handposture_dictionnary.py](../src/utils/handposture_dictionnary.py).
...
```
Trained h5 model can be found in the [model zoo on GH](https://github.com/STMicroelectronics/stm32ai-modelzoo/tree/master/hand_posture/) or ../experiments_outputs folders.
