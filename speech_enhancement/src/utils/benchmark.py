...
''' The functions in this file are taken from common/benchmarking and common/utils.
    Unfortunately, importing them from the common/ subpackage induces a Tensorflow dependency,
...
def get_model_name_and_its_input_shape(model_path):
...
def benchmark(cfg: DictConfig = None, model_path_to_benchmark: Optional[str] = None,
    ...
    model_path = model_path_to_benchmark
