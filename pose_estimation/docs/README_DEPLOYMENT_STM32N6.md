# Pose Estimation STM32N6 Model Deployment
...
- `aspect_ratio`:
  ...
  - `full_screen` Resize camera image to NN input size and display a maximized image. See [Aspect Ratio Mode](../../application_code/pose_estimation/STM32N6/Doc/Build-Options.md#aspect-ratio-mode)
- `color_mode`:
  - `rgb`
  - `bgr`
